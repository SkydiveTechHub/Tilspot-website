        ...
        <Container>
            <div className='flex flex-col lg:flex-row justify-between items-center space-y-6'>
                <div className='relative flex-1'>
                    ...
                    <img className='hidden lg:block absolute top-[170px] right-5' src="/images/c2.png" alt="connect image" />
                    <img className='lg:hidden absolute h-[300px] top-5' src="/images/c2.png" alt="connect image" />
                </div>
            ...
            <div className='flex flex-col lg:flex-row-reverse justify-between items-center mt-[4rem] md:mt-[7rem] gap-8'>
                <div className='relative flex-1'>
                    ...
                    <img className='hidden lg:block absolute top-[250px] left-5' src="/images/c4.png" alt="connect image" />
                    <img className='lg:hidden absolute h-[250px] right-0 top-[9rem]' src="/images/c4.png" alt="connect image" />
                </div>
