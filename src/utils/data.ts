...
export const reasonData = [
  {
    ...
    header: "Easy Access",
    text: "Our services are accessible easily with no extra help.",
  },
  {
    logo: "/images/reliable.svg",
    header: "Reliability",
    text: "You can confidently sit back after utilizing our services with the assurance that your messages will be successfully delivered.",
  },
  {
    logo: "/images/afford.svg",
    header: "Affordability",
    text: "Our services are reasonable to afford as you can even earn for sharing Tilspot to friends and family.",
  },
  {
    logo: "/images/fast.svg",
